...
public class GameData implements Serializable {
	...
	int pX, pY, heroHealth, keyNum, gsNum;
	int[][][] map;
	...
	void printMap() {
		...
		System.out.print(
				"Health:" + Integer.toString(heroHealth) + "  KeyNum:" + Integer.toString(keyNum) + "GreenStoneNum:" + Integer.toString(gsNum) + "  Menu:press 0\n");
	}
